...
const Header = () => {
  ...
  const handleSearchClick = async () => {
    ...
    try {
       // Primero intentamos buscar por etiqueta
       // Si no encontramos resultados por etiqueta, intentamos buscar por título
      ...
      const dataPorEtiqueta = await buscarContenidoPorEtiqueta(query);  // Llamamos a la nueva función de búsqueda por etiqueta
        ...
        <div style={styles.profileContainer}>
          ...
          {showMenu && (
            <div style={styles.dropdown}>
              ...
              <div style={styles.menuItem}>Perfil</div>
              <div style={styles.menuItem}>Sube a Premium</div>
              <div style={styles.menuItem}>Asistencia</div>
              <div style={styles.menuItem}>Descargar</div>
